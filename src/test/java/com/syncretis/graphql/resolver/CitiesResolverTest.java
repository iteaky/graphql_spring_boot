package com.syncretis.graphql.resolver;
...
class CitiesResolverTest {
    ...
    void get() throws IOException {
        ...
        List<CityTestDTO> actual = (List<CityTestDTO>) graphQLResponse.get("$['data']['cities']", List.class).stream()
